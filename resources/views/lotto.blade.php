...
@section('content')
    <header class="text-center mb-12">
        ...
        <div class="mt-4">
            <a href="{{ route('lotto.stats') }}" class="text-blue-400 hover:text-blue-300 font-semibold underline decoration-2 underline-offset-4 transition-colors">
        ...
        <div class="grid gap-8 md:grid-cols-1" style="margin-bottom: 20px; margin-top: 10px;">
            <div class="card-glass rounded-3xl p-8 transform transition hover:scale-105 duration-300">
                ...
                <div class="flex justify-center">
                    <a href="{{ route('lotto.checker', ['numbers' => $draw['numbers']]) }}"
                       target="_blank"
